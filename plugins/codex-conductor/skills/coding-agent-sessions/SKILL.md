...
description: "Use when asked to find, read, list, search, inspect, export, or reconstruct local coding-agent sessions across Codex, Claude, OpenCode, and other supported agent stores. Covers transcripts, session IDs, child linkage, cwd/model/time/token filters, archives, and fuzzy recall."
---

# Coding Agent Sessions

> Modified from the OMO 4.17.1 shared skill: Conductor softens automatic
> activation while retaining the finder and format knowledge. See `LICENSE.md`.
