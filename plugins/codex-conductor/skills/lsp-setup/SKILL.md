---
name: lsp-setup
description: "Configure a Language Server (LSP) for a specific language so diagnostics, go-to-definition, references, and rename work. Use to install or select a server, fix missing LSP configuration, or wire .codex/lsp-client.json and .opencode/lsp.json. Routes by file extension to language-specific setup and verification references."
---

# LSP Setup

> Selected from OMO 4.17.1 with a shortened Conductor activation description
> and Conductor-specific agent metadata. See `LICENSE.md`.
